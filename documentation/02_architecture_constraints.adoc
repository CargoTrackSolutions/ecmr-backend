...
| BSD3 | Basic Stack for Development: programming languages      | Programming Languages: Java
...
| O1 | Process model | Development, agile/Scrum. To describe the architecture arc42 is used.
| O2 | Development tools |

Java source code created in IntelliJ.
| O3 | Configuration management      | Git at GitLab hosted by Open Logistics Foundation
| O4 | Test tools and test processes | Unit testing as part of a CI/CD Pipeline (stage test)

Java based components: SpringBootTest

| O5 | Other tools | Maven 3.8.6 for Build Management

Spring Boot 3.4.5 as Application Framework (Java)
...
| P2 | All dependencies are Open Source | A complete list of (transitive) dependencies and their Open Source licenses needs to be provided
|===
...
| C2 | Coding guidelines for Java       | https://google.github.io/styleguide/javaguide.html[Google Java coding conventions]
...
| C4 | Versioning                       | Semantic Versioning 2.0.0 (https://semver.org/lang/de/)
