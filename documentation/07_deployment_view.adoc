...
This option provides a complete, production-ready eCMR setup with flexibility in deployment, branding, and system integration.
...
====== 3. Download the eCMR Components
...
====== 6. Configure eSEAL and Digital Signatures

* Configure a key pair, keystores, and signature settings. See <<eseal-configuraton>> for detailed configuration.
...
====== 9. Verify APIs and Frontend Functionality
...
====== 10. Integrate with Existing IT Systems
...
The eCMR API is defined in the provided https://git.openlogisticsfoundation.org/wg-electronictransportdocuments/ecmr/ecmr-backend/-/blob/0a1cbe99836af26ce754fdb273f45cc90f193246/openapi.yaml[openapi.yml] file and enables:
...
==== Prerequisites for Quick Onboarding
====
* Access to the https://git.openlogisticsfoundation.org/wg-electronictransportdocuments/ecmr/ecmr-backend/-/blob/0a1cbe99836af26ce754fdb273f45cc90f193246/openapi.yaml[openapi.yml]  file defining the eCMR API
